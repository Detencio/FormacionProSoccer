...
def clean_and_insert():
    ...
    try:
        ...
        # Posiciones específicas con abreviaciones cortas
        positions = [
            ...
            ("MCD", "Mediocentro Defensivo", zone_map.get("MED")),
            ("MC", "Mediocentro", zone_map.get("MED")),
            ("MCO", "Mediocentro Ofensivo", zone_map.get("MED")),
            ...
            ("SD", "Segundo Delantero", zone_map.get("DEL"))
        ]
