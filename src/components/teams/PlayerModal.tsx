...
export default function PlayerModal({ isOpen, onClose, onSubmit, player, teamId, loading = false }: PlayerModalProps) {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      const playerData = {
        ...
        position_zone_id: parseInt(formData.position_zone_id.toString()) || 1,
        ...
        skill_level: parseInt(formData.skill_level.toString()) || 5,
        height: formData.height && formData.height.toString().trim() !== '' ? parseInt(formData.height.toString()) || undefined : undefined,
        weight: formData.weight && formData.weight.toString().trim() !== '' ? parseInt(formData.weight.toString()) || undefined : undefined,
        photo_url: formData.photo_url,
        is_active: true,
        // Habilidades específicas
        rit: parseInt(formData.rit.toString()) || 70,
        tir: parseInt(formData.tir.toString()) || 70,
        pas: parseInt(formData.pas.toString()) || 70,
        reg: parseInt(formData.reg.toString()) || 70,
        defense: parseInt(formData.defense.toString()) || 70,
        fis: parseInt(formData.fis.toString()) || 70
      };

      if (formData.position_specific_id && formData.position_specific_id !== undefined) {
        (playerData as any).position_specific_id = formData.position_specific_id;
      }
  ...
  // Calcular altura dinámica del modal
  const modalHeight = Math.min(viewportHeight - 32, 800); // Máximo 800px, mínimo 32px de margen

  return (
    <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50 p-2 sm:p-4">
      <div 
        className="bg-white rounded-xl shadow-2xl border border-gray-100 w-full max-w-4xl mx-auto flex flex-col"
        style={{ 
      ...
      >
        ...
        <div className="bg-gradient-to-r from-blue-600 to-green-600 text-white p-4 sm:p-6 text-center flex-shrink-0">
        ...
        <div className="flex-1 overflow-y-auto min-h-0">
          <form onSubmit={handleSubmit} className="p-4 sm:p-6 space-y-4">
            ...
            <div className="space-y-3">
              <h3 className="text-base sm:text-lg font-semibold text-gray-800 mb-3">Información Personal</h3>
            ...
            <div className="space-y-4">
              <h3 className="text-base sm:text-lg font-semibold text-gray-800 mb-3">Información de Posición</h3>
            ...
            <div className="space-y-3">
              <h3 className="text-base sm:text-lg font-semibold text-gray-800 mb-2">Nivel de Habilidad General</h3>
            ...
            {/* Habilidades Específicas */}
            <div className="space-y-3">
              <h3 className="text-base sm:text-lg font-semibold text-gray-800 mb-2">Habilidades Específicas</h3>
            ...
            <div className="space-y-3">
              <h3 className="text-base sm:text-lg font-semibold text-gray-800 mb-2">Asignación de Equipo</h3>
            ...
            <div className="space-y-3">
              <h3 className="text-base sm:text-lg font-semibold text-gray-800 mb-2">Información Adicional</h3>
