          ...
          <div className='flex items-center space-x-4'>
            ...
            <div>
              ...
              <div className='flex items-center space-x-4 mt-2'>
                ...
                <span className='text-green-300 text-sm font-medium'>{'CL'}</span>
              </div>
            </div>
          </div>
            ...
            {loading ? (
              ...
              <div className='grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4'>
                {players.map(player => (
                  <div
                    key={player.id}
                    className='bg-gradient-to-br from-gray-700 to-gray-800 p-4 rounded-2xl border border-gray-600/50 hover:border-blue-500/50 transition-all duration-300 group hover:shadow-xl'
                  >
